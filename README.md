...
## 结果（W6 baseline 待填，来自 `data/metrics.json`）
对标实验：Li₆PS₅Cl 室温 ~3.15 mS/cm（烧结）/ 1.33 mS/cm（机械化学）。

| MLIP | D(cm²/s) @1000K | σ(300K) 外推 (mS/cm) | Eₐ (eV) | 与实验 3.15 倍率 | 备注 |
|---|---|---|---|---|---|
| MACE-MP-0 (baseline) | _待填_ | _待填_ | _待填_ | _待填_ | 未微调 |
| MatterSim (baseline) | _待填_ | _待填_ | _待填_ | _待填_ | 未微调 |
